...
try {
    ...
    $requete = $db->prepare('DELETE FROM CRITERIA WHERE id_criteria = :id');
...
<head>
    ...
    <title>DNMADE - Suppression</title>
    ...
    <div class="text-center">
        <div class="card shadow p-4">
            <?php if ($Error == null)
                ...
                <p class=\"mt-3\">Critère supprimé avec succès !</p>";
            else {
                ...
                <p class=\"mt-3\">Une erreur est survenue lors de la suppression du critère.</p>";
            }
            ?>

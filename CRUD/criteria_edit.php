...
try {
    $requeteInsert = $db->prepare("UPDATE CRITERIA SET criteria = :criteria WHERE id_criteria = :id");
    ...
    <div class="text-center">
        <div class="card shadow p-4">
            <?php if ($Error == null)
                ...
                <p class=\"mt-3\">Critère modifié avec succès !</p>";
            else {
                ...
                <p class=\"mt-3\">Une erreur est survenue lors de la modification du critère.</p>";
            }
            ?>
